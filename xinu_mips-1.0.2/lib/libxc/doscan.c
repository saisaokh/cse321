 ...
 *
 * $Id: doscan.c 221 2007-07-11 18:45:46Z mschul $
 */
...
int _innum(int **ptr, int type, int len, int size, int (*getch)(), int (*ungetch)(), int arg1, int arg2, int *eofptr)
{
...
int _instr(register char *ptr, int type, int len, int (*getch)(), int (*ungetch)(), int arg1, int arg2, int *eofptr)
{
